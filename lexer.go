			...
			if line[i+1] == 'h' {
				if line[i+2] == 'a' {
					if line[i+3] == 'r' {
						...
						i = i + 3
					} else { printError(line, lineNumber, i+3) }
				} else { printError(line, lineNumber, i+2) }
			} else { printError(line, lineNumber, i+1) }
		} else if line[i] == 'f' {
			if line[i+1] == 'o' {
				if line[i+2] == 'r' {
					...
					if line[i+3] == 'o' {
						if line[i+4] == 'r' {
							if line[i+5] == 'y' {
								...
								i = i + 5
							} else { printError(line, lineNumber, i+5) }
						} else { printError(line, lineNumber, i+4) }
					} else { printError(line, lineNumber, i+3) }
				} else { printError(line, lineNumber, i+2) }
			} else { printError(line, lineNumber, i+1) }
		} else if line[i] == 'n' {
						...
						if line[i+4] == 't' {
							if line[i+5] == 'e' {
								if line[i+6] == 'r' {
									...
									i = i + 6
								} else { printError(line, lineNumber, i+6) }
							} else { printError(line, lineNumber, i+5) }
						} else { printError(line, lineNumber, i+4) }
					} else { printError(line, lineNumber, i+3) }
				} else { printError(line, lineNumber, i+2) }
